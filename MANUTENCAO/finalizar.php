<?php 
   ...
   /* if (!isset($_SESSION['MAN_ADM']) or $_SESSION['logon'] == 0 or !isset($_SESSION['MAN_ADM'])){
      header("Location: /FORMS/login/index.php");
    }

    if ($_SESSION['MAN_ADM'] == 0){
      header("Location: /FORMS/login/index.php");
    }
*/
?>
...
<body class="consulta" style="background-color: #d8d8d8; ">
    ...
    <div class="cardd" >
      <p>ORDEM DE SERVIÇO EM ANDAMENTO (FINALIZAÇÃO)</p>
                  ...
                  if (!isset($num)){
                      ...
                      if ($adm == 0){
                        ...
                        SELECT num_solicitacao, data_solicitacao,hora_solicitacao, nome_solicitante,setor_solicitante, 
                          ...
                          FROM form_manut 
                          WHERE nome_executante = '$func'
                          ORDER BY (data_solicitacao, hora_solicitacao) DESC
                        ) AS x WHERE finalizada = 'NAO'";
...
*/
                      ...
                      foreach($myPDO->query($sql)as $row){
                        ...
                        if ($finalizada == 'SIM'){ 
                            $link2 = "href='finalizacao.php?id=".$linked."'";
                        }
