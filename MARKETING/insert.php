<?php 
  ...
  $result = pg_query($conexao, "INSERT INTO form_mkt (nome_solicitante, data_solicitacao, hora_solicitacao, setor_solicitante, tipo_servico, nome_recebimento, descricao, nome_executante, empresa) 
  VALUES ('$nome_solicitante', '$data_solicitacao', '$hora_solicitacao', '$setor', '$tipo_servico', '$nome_recebimento', '$descricao_sem_Caracteres_especiais', '$nome_executante', '$empresa')");
