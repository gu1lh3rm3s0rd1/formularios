...
<body class="consulta" style="background-color: #d8d8d8; ">
    ...
    <div class="cardd" >
      <p>ORDEM DE SERVIÇO EM ANDAMENTO (EXECUÇÃO)</p>
<br>
          ...
          <?php
              ...
              try{
                  ...
                  if (!isset($num)){
                      ...
                      x.hora_fechamento,x.nome_responsavel,x.empresa, x.executada
                      FROM
                      (
                      SELECT num_solicitacao, data_solicitacao, hora_solicitacao, nome_solicitante,setor_solicitante, tipo_servico, nome_recebimento, 
                                ...
                                CASE WHEN data_inicio IS NULL THEN 'NAO' ELSE 'SIM' END AS executada
                        FROM form_manut
                      ...
                      foreach($myPDO->query($sql)as $row){
                        ...
                        if ($tamanho == 1){
                            ...
                            $link2 = "href='abrir.php?id=".$linked."'";
                            echo '
