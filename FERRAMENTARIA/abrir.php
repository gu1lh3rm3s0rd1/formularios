...
<form method="get">
    <?php
        ...
        $query = "SELECT num_solicitacao, nome_solicitante, to_char(data_solicitacao, 'DD/MM/YYYY') as data_solicitacao, hora_solicitacao, 
                    setor_solicitante, tipo_servico, num_equipamento, nome_equipamento, nome_recebimento, nome_executante, descricao
    ...
    <body class="claro">
        <form method="get" id="initial">
            ...
            <div class="horizontal ctr2">
                <div class="align">
                    <div class="box2">
                        <label for="x" class="ali2">Equipamento:</label>
                        <input name="nome_equip" readonly type="text" value="<?php echo $nome_equipamento; ?>" class="input-padrao">
                    </div>

                    <div class="box1">
                        <label for="x" class="ali4">Equipamento Nº:</label>
                        <input name="num_equip" readonly type="text" value="<?php echo $num_equipamento; ?>" class="input-padrao3">
                    </div>
                </div>
            </div>
                ...
                <script language=javascript>
                    function confirmacao(){
                        if (confirm("Deseja mesmo cancelar? Dados serão perdidos"))
                            window.location.href = "consulta.php?selecione=Todos";
                        }
