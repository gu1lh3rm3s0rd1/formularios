...
<head>
    ...
    <meta http-equiv="refresh" content="5 /FORMS/MANUTENCAO/GRAPH/index.php">
    <link rel="stylesheet" href="estilo.css">
    <title>VISUALIZAÇÃO</title>
</head>
 
<header class="top auto ctr2">
        <img class="ctr2" src="img/logo-chiaperini.png" alt="img"><p class="white" style="margin-left: 10px; font-size: 1.5vw;">RELATÓRIO DE ORDEM DE SERVIÇO FERRAMENTARIA</p>
</header>
