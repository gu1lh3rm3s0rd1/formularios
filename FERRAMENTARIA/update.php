<?php 
    ...
    $result = pg_query($conexao, "UPDATE form_fer SET nome_responsavel = '$nome_responsavel', data_fechamento = '$data_solicitacao', hora_fechamento = '$hora_solicitacao', obs_exec = '$obs_exec', status = '$status'
