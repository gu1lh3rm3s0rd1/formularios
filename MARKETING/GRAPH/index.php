...
<header class="top auto ctr2">
        <img class="ctr2" src="img/logo-chiaperini.png" alt="img"><p class="white" style="margin-left: 10px; font-size: 1.5vw;">RELATÓRIO DE ORDEM DE SERVIÇO MARKETING</p>
</header>
  ...
  <?php
    try{
     ...
     if ($status == 'ABERTA') {
        ...
        echo '<td class="andamento" style="padding: 10px 10px;">'.$nome_exec.'</td>';
