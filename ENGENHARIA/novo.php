            ...
            <div class="horizontal ctr2">
                <div class="align">
                        ...
                        <select name="nome_solicit" required class="input-padrao" id="nome">
                            <option value="">SELECIONE</option>
                                <?php
                                        ...
                                        $query = $myPDO->query("
                                        SELECT f.nome as funcionario, d.setor as cod_setor
                                        FROM form_func f
                                        ...
                                        foreach($registros as $option) {
                                            ?>
                                                <option value="<?php echo $option['funcionario']?>"><?php echo $option['funcionario']?></option>
                                            <?php
                                        }
                                ?>
                        </select>
                    ...
                    <script type="text/javascript">
                        ...
                        let selectSolicit = document.getElementById('nome');

                        selectSolicit.onchange = () => {
                            let selectSetor = document.getElementById('setor');
                            let valor = selectSolicit.value;

                            fetch('select_setor.php?nome=' + valor)
                                .then(
                                    response => {
