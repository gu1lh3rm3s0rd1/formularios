...
<?php
    ...
    try{
        ...
        $sql = "SELECT num_solicitacao FROM form_fer ORDER BY num_solicitacao DESC LIMIT 1";
            ...
            <div class="horizontal ctr2">
                <div class="align">
                    <div class="box1">
                        ...
                        <select name="nome_solicit" required class="input-padrao" id="solicit">
                            ...
                            <option value="">SELECIONE</option>
                                <?php
                                    try{
                                        ...
                                        $sql = "SELECT * FROM form_serv WHERE painel = 'FER'";
                            ...
                            <option value="">SELECIONE</option>
                                <?php
                                    ...
                                    try{
                                        ...
                                        $sql = "SELECT f.nome as funcionario
                                        FROM form_func f
                                        INNER JOIN form_emp e ON f.empresa=e.cod WHERE f.empresa=1 
                                        ORDER BY f.nome ASC"; // O "1" VAI FORÇAR VIM SOMENTE FUNCIONÁRIOS DA CHIAPERINI
